...
const environmentSchema = z.object({
  ...
  GITHUB_ACCESS_TOKEN_SECRET_NAME: z.string().default("github/sac-populicom/token")
});
...
export const getPublicConfig = (source: Record<string, string | undefined> = process.env) => {
